...
- [x] **CHAT-04**: User can configure and switch between OpenAI-compatible model providers (OpenAI, Ollama, Anthropic)
...
- [x] **SAFE-04**: All tool executions are recorded in an audit log
